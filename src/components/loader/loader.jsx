...
export default function Loader() {
  return (
    <div className="fixed w-screen h-screen bg-gray-400 bg-opacity-50 flex flex-col items-center justify-center inset-0 backdrop-blur-md">
           <div className='bg-white rounded-full p-3 border-2 border-mycolor flex flex-row items-center animate-pulse'>
        <img src='/logo.jpeg' className='w-10 h-10 rounded-full animate-pulse' />
      </div>
    </div>
  );
}
